        ...
        <div class="row">
                ...
                <div id="header-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" style="border-radius: 10px;">
                        <div class="carousel-item active" >
                            <img class="img-fluid" src="https://photo.znews.vn/w1200/Uploaded/piqbzcvo/2022_08_20/The_anime_daily.png">
                            
                        </div>
                        <div class="carousel-item" >
                            <img class="img-fluid" src="https://media.hanamtv.vn/upload/image/202105/thumbnail/69066_14.jpg">
                            
                        </div>
                        <div class="carousel-item" >
                            <img class="img-fluid" src="https://kilala.vn/data/article/mangaweb.jpg">
            ...
            <div class="col-lg-4">
                <div class="product-offer" >
                    <img class="img-fluid" src="public/img/banner/sale1.png" alt="">
                    
                </div>
                
                <div class="product-offer">
                    <img class="img-fluid" src="public/img/banner/aduuu.jpg" alt="">
...
<section class="product spad" style="background-color: #FFFFCC;">
...
<!-- Banner Section Begin -->
<section class="banner set-bg" data-setbg="public/img/banner/abcdefg.jpg">
    <div class="container">
        <div class="row">
        ...
        <div class="row">
            <div class="col-lg-6 p-0">
                <div class="discount__pic">
                    <img src="public/img/discount-22.jpg" alt="Hình ảnh">
                </div>
            </div>
            <div class="col-lg-6 p-0">
